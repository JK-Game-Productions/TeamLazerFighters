...
public class CameraOrbit3D {
    ...
    private void setupInputs(InputManager im) { // findout what sting is gamepad vs keyboard
        ...
        OrbitRadiusAction radiAction = new OrbitRadiusAction(); // Left/right bummpers z\x Can i assign this action to
                                                                // two different buttons if the class can determine the
                                                                // input
        ...
        im.associateActionWithAllKeyboards(Component.Identifier.Key.X, radiAction,
                InputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
        // Controller Camera
        im.associateActionWithAllGamepads(Component.Identifier.Axis.RX, azmAction,
                InputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
        im.associateActionWithAllGamepads(Component.Identifier.Axis.RY, elevAction,
                InputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
        im.associateActionWithAllGamepads(Component.Identifier.Button._4, radiAction,
                InputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
        im.associateActionWithAllGamepads(Component.Identifier.Button._5, radiAction,
                InputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
    }
    ...
    public void updateCameraPosition() {
        ...
        double playerAngle = Math
                .toDegrees((double) playerRot.angleSigned(new Vector3f(0, 0, -1), new Vector3f(0, 1, 0)));
