...
public class GameObject {
	...
	protected Iterator<GameObject> getChildrenIterator() {
	...
	public void setLocalForwardVector(Vector4f v) {
		localRotation.setColumn(2, v);
	}

	public void setLocalUpVector(Vector4f v) {
		localRotation.setColumn(1, v);
	}

	public void setLocalRightVector(Vector4f v) {
		localRotation.setColumn(0, v);
	}
	...
	/**
	 * This function rotates the game object around the Y axis based off time and
	 * direction
	 */
	...
	public void yaw(float mouseDeltaX) {
		...
		if (mouseDeltaX < 0.0)
			...
			tilt = 0.0f;
		this.setLocalRotation((new Matrix4f().rotation(tilt * 0.01f, new Vector3f(oldRot.x(), oldRot.y(), oldRot.z())))
				.mul(this.getWorldRotation()));
	}
	...
	/** returns the scale of a gameobject */
	public float getScale() {
		Vector3f scale = new Vector3f();
		scale = this.getWorldScale().getScale(scale);
		return scale.x();
	}

	/** This function changes the scale of a gameobject based off a factor */
	public void changeScale(float factor) {
		this.setLocalScale((new Matrix4f())
				.scaling((new Vector3f(factor, factor, factor)).mul(this.getWorldScale().getScale(new Vector3f()))));
	}

	/** This function sets the class variable collected to true */
	public void collect() {
		collected = true;
	}

	/** This function returns the boolean value of the class variable collected */
	public boolean isCollected() {
		return this.collected;
	}

	/**
	 * This function moves a Game Object along its Z axis based on the objects move
	 * factor
	 */
	public void move(float frameDiff) {
		Vector3f oldPos = this.getWorldLocation();
		Vector4f mov = new Vector4f(0f, 0f, 1f, 1f);
		mov.mul(this.getWorldRotation());
	...
	public void setMoveFact(float newMovFactor) {
		movFactor = newMovFactor;
	}

	/** This function returns a float of the class variable movFactor */
